...
struct arguments_t {
    ...
    struct keyvalue_t{
        enum mode_t{ NOTE_SET=0, GET_AVAILABLE_HAPTICS, LOAD_RAW_EFFECT_FILE, GET_SUPPORTED_EFFECTS, TRIGGER_EFFECT, SET_FORCE, TRIGGER_SEGA_FFB_RAW_REQUEST, DUMP_RAW_SEGA_FFB_CONTROLLER} mode;
        char value[64];
    }keyvalue[10];
}arguments;
